...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { produto_id: @pedido.produto_id, quantidade: @pedido.quantidade, usuario_id: @pedido.usuario_id } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { produto_id: @pedido.produto_id, quantidade: @pedido.quantidade, usuario_id: @pedido.usuario_id } }
